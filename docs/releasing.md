...
git tag -a v0.9.0 -m 'gopherkind 0.9.0'
git push origin v0.9.0
gh release create v0.9.0 --verify-tag --generate-notes
```
...
gh release download v0.9.0 \
  ...
  --dir gopherkind-0.9.0-release
cd gopherkind-0.9.0-release
shasum -a 256 -c SHA256SUMS
npm login
npm publish ./gopherkind-0.9.0.tgz --access public
```

The npm account must have two-factor authentication enabled. Check the package
page and install `gopherkind@0.9.0` in a clean temporary directory before
